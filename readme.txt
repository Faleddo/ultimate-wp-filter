...
Tags: fxfilter, profanity, security, filter, language, post, comment, bbpress, child, custom
...
1. Explicit content after filtering
2. Explicit post before filtering
3. Explicit comment before filtering
...
= 2.0.0 =
* new with FX Profanity Filter service API
